      ...
      <div className="flex flex-col justify-between min-h-screen w-full max-w-5xl">
        <div className="w-full mt-20 sm:mt-40 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-10 sm:gap-0">
          <div className="w-full sm:w-auto">
            ...
            <p className="text-gray-400 mb-6 sm:mb-8 max-w-md text-lg sm:text-2xl leading-relaxed">
            ...
            <a
              ...
              className="flex items-center gap-2 text-base sm:text-lg font-semibold hover:text-gray-400"
            >
          ...
          <div className="w-full sm:w-auto">
            <h3 className="uppercase text-xs sm:text-sm tracking-widest text-gray-400 mb-4 sm:mb-6">
              Elsewhere
            </h3>
        ...
        <footer className="mt-auto text-start text-gray-400 text-xs sm:text-sm py-6 border-t border-gray-700">
